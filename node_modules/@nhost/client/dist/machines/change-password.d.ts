...
export declare const createChangePasswordMachine: ({ backendUrl, interpreter }: Nhost) => import("xstate").StateMachine<ChangePasswordContext, any, ChangePasswordEvents, {
    value: any;
    context: ChangePasswordContext;
}, import("xstate").BaseActionObject, import("xstate").ServiceMap, import("./change-password.typegen").Typegen0 & {
